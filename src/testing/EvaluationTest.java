...
class EvaluationTest
{
  ...
  {
    assertEquals(new ComplexNumber(5.2, 3.6), evaluateExpression("(3.6+1.8𝘪)+(1.6+1.8𝘪)"));
  }
  ...
  {
    assertEquals(new ComplexNumber(5.6, 2.3), evaluateExpression("(9.5+4.2𝘪)-(3.9+1.9𝘪)"));
  }
  ...
  @Test void testMixedAddSubtract() throws ExpressionEvaluationException
  {
    assertEquals(new ComplexNumber(68.45, -68.69),
        evaluateExpression("(5.0+4𝘪)+(6.3-2𝘪)-(-16.4+0.13𝘪)-(0.6+34.56𝘪)+(41.35-36𝘪)"));
  }

  @Test void testMultiply() throws ExpressionEvaluationException
  {
    assertEquals(new ComplexNumber(38.24, 4.42), evaluateExpression("(5.4+3.2𝘪)*(5.6-2.5𝘪)"));
  }
  ...
  @Test void testMultiplyMultiple() throws ExpressionEvaluationException
  {
    assertEquals(new ComplexNumber(-1303.471, 599.167),
        evaluateExpression("(5.4+3.2𝘪)*(5.6-2.5𝘪)*(-0.1+7.9𝘪)*(2.5+4𝘪)"));
  }
  ...
  @Test void testMultipleDivide() throws ExpressionEvaluationException
  {
    assertEquals(Calculate.divide(
        ...
        new ComplexNumber(5.5, 4.7)), evaluateExpression("(5.4+3.2𝘪)/(5.6-2.5𝘪)/(5.5+4.7𝘪)"));
  }
  ...
  @Test void testMixedMultiplyDivide() throws ExpressionEvaluationException
  {
    assertEquals(new ComplexNumber(100.02523318266418505716, 36.43315767083222547194894),
        evaluateExpression("(3.67-13.9𝘪)*(5.4+3.2𝘪)/(5.6-2.5𝘪)*(5.5+4.7𝘪)"));
  }

  @Test void testAddInFrontOfMultiply() throws ExpressionEvaluationException
  {
    assertEquals(new ComplexNumber(45.0, 4.0), evaluateExpression("(5+4𝘪)+(6-2𝘪)*(6+2𝘪)"));
  }

  @Test void testAddInFrontOfDivide() throws ExpressionEvaluationException
  {
    assertEquals(new ComplexNumber(5.8, 3.4), evaluateExpression("(5+4𝘪)+(6-2𝘪)/(6+2𝘪)"));
  }

  @Test void testSubtractInFrontOfMultiply() throws ExpressionEvaluationException
  {
    assertEquals(new ComplexNumber(-35.0, +4.0), evaluateExpression("(5+4𝘪)-(6-2𝘪)*(6+2𝘪)"));
  }

  @Test void testSubtractInFrontOfDivide() throws ExpressionEvaluationException
  {
    assertEquals(new ComplexNumber(4.2, 4.6), evaluateExpression("(5+4𝘪)-(6-2𝘪)/(6+2𝘪)"));
  }

  @Test void testMultiplyInFrontOfAdd() throws ExpressionEvaluationException
  {
    assertEquals(new ComplexNumber(44.0, 16.0), evaluateExpression("(5+4𝘪)*(6-𝘪)+(6+2𝘪)"));
  }

  @Test void testDivideInFrontOfAdd() throws ExpressionEvaluationException
  {
    assertEquals(new ComplexNumber(6.55, 2.85), evaluateExpression("(5+4𝘪)/(6-2𝘪)+(6+2𝘪)"));
  }

  @Test void testMultiplyInFrontOfSubtract() throws ExpressionEvaluationException
  {
    assertEquals(new ComplexNumber(32.0, 12.0), evaluateExpression("(5+4𝘪)*(6-2𝘪)-(6+2𝘪)"));
  }

  @Test void testDivideInFrontOfSubtract() throws ExpressionEvaluationException
  {
    assertEquals(new ComplexNumber(-5.45, -1.15), evaluateExpression("(5+4𝘪)/(6-2𝘪)-(6+2𝘪)"));
  }
  ...
  @Test void testArithmeticExpressionsNoParens() throws ExpressionEvaluationException
  {
    assertEquals(new ComplexNumber(-7.45, -39.75),
        evaluateExpression("(5+4𝘪)/(6-2𝘪)-(6+2𝘪)*(3+5𝘪)+(-4.6𝘪)"));
  }
  ...
  {
    assertEquals(new ComplexNumber(62.0, 34.0), evaluateExpression("((5+4𝘪)+(6-2𝘪))*(6+2𝘪)"));
  }

  @Test void testParensAddInFrontOfDivide() throws ExpressionEvaluationException
  {
    assertEquals(new ComplexNumber(1.75, -0.25), evaluateExpression("((5+4𝘪)+(6-𝘪))/(6+2𝘪)"));
  }

  @Test void testParensSubtractInFrontOfMultiply() throws ExpressionEvaluationException
  {
    assertEquals(new ComplexNumber(-18.0, +34.0), evaluateExpression("((5+4𝘪)-(6-2𝘪))*(6+2𝘪)"));
  }

  @Test void testParensSubtractInFrontOfDivide() throws ExpressionEvaluationException
  {
    assertEquals(new ComplexNumber(0.15, 0.95), evaluateExpression("((5+4𝘪)-(6-2𝘪))/(6+2𝘪)"));
  }

  @Test void testParensMultiplyInFrontOfAdd() throws ExpressionEvaluationException
  {
    assertEquals(new ComplexNumber(44.0, 16.0), evaluateExpression("((5+𝘪)*(6-𝘪))+(6+2𝘪)"));
  }
  ...
  {
    assertEquals(new ComplexNumber(60.0, 48.0), evaluateExpression("(5+4𝘪)*((6-2𝘪)+(6+2𝘪))"));
  }
  ...
  {
    assertEquals(new ComplexNumber(16.0, -20.0), evaluateExpression("(5+4𝘪)*((6-2𝘪)-(6+2𝘪))"));
  }

  @Test void testDivideInFrontOfParensSubtract() throws ExpressionEvaluationException
  {
    assertEquals(new ComplexNumber(-1.0, +1.25), evaluateExpression("(5+4𝘪)/((6-2𝘪)-(6+2𝘪))"));
  }
  ...
  @Test void testArithmeticExpressionParens() throws ExpressionEvaluationException
  {
    assertEquals(
        ...
        evaluateExpression("(5+4𝘪)/((6-2𝘪)-(6+2𝘪)*(9)) + (4-6𝘪)/((3.6)-(4.7𝘪) + (9𝘪))"));
  }
